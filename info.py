...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6445840990').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002055127272').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '-1002073485610').split()]
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/wrchats')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/wrmovies')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/How_To_Open_Linkl')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'wrchats') # Support Chat Link Without https:// or @
...
VERIFY_SHORTLINK_URL = environ.get('VERIFY_SHORTLINK_URL', 'livekhabar.online')
VERIFY_SHORTLINK_API = environ.get('VERIFY_SHORTLINK_API', '2e70cafacf38e6de4b1575760eacb79166878f11')
...
SHORTLINK_URL = environ.get('SHORTLINK_URL', 'api.livekhabar.online')
